...
Mock.mock('http://localhost:8080/getAside', (data) => getAside(data))
...
function getTeachers(){
    return {
        ...
        table:{
            ...
            data:[{"age":31,"cname":"101","email":"20201001@qq.com","id":1,"telephone":"20201001000","tid":"20201001","tname":"安老师"},
            {"age":31,"cname":"202","email":"20201002@qq.com","id":2,"telephone":"20201002000","tid":"20201002","tname":"徐老师"},
            {"age":30,"cname":"102","email":"20201003@qq.com","id":3,"telephone":"20201003000","tid":"20201003","tname":"王老师"},
            {"age":29,"cname":"201","email":"20201004@qq.com","id":4,"telephone":"20201004000","tid":"20201004","tname":"何老师"}]
        }
    }
}
Mock.mock('http://localhost:8080/getTeachers', getTeachers)

Mock.mock('http://localhost:8080/teacher/add', (data) => {
    console.log('mock received:',data.body);
    return{
        code:200
    }
})
Mock.mock('http://localhost:8080/teacher/delete', (data) => {
    console.log('mock received:',data.body);
    return{
        code:200
    }
})
Mock.mock('http://localhost:8080/teacher/updata', (data) => {
    console.log('mock received:',data.body);
    return{
        code:200
    }
...
Mock.mock('http://localhost:8080/user/add', (data) => {
    console.log('mock received:',data.body);
    return{
        code:200
    }
})
Mock.mock('http://localhost:8080/user/delete', (data) => {
    console.log('mock received:',data.body);
    return{
        code:200
    }
})
Mock.mock('http://localhost:8080/user/updata', (data) => {
    console.log('mock received:',data.body);
    return{
        code:200
    }
...
Mock.mock('http://localhost:8080/login', (LoginData) => {
    console.log('mock received login:',LoginData);
    let type=''
    let username = JSON.parse(LoginData.body).username
    
    if(username[0]== '1'){
        type='学生'
        username = '学生甲'
    }else if(username[0]== '2'){
        type='教师'
        username = '教师乙'
